...
describe 'Buffet owner sees messages on order page' do
  it 'ordered by descending datetime' do
    ...
    within 'main section:last' do
      ...
      within 'dl' do
        ...
        within 'dd:nth(2)' do
          expect(page)
            .to have_content (I18n.localize third_message.created_at.localtime)
            .slice(5..-1)
            .slice 0..-7
        end
        ...
        within 'dd:nth(4)' do
          expect(page)
            .to have_content (I18n.localize second_message.created_at.localtime)
            .slice(5..-1)
            .slice 0..-7
        end
        ...
        within 'dd:nth(6)' do
          expect(page)
            .to have_content (I18n.localize first_message.created_at.localtime)
            .slice(5..-1)
            .slice 0..-7
        end
      end
