...
describe 'buffet owner approve order' do
  ...
  it 'with success' do
    ...
    within 'main form' do
      ...
      fill_in 'Data de Validade do Preço', with: I18n.localize(Date.current + 1.week)
  ...
  it 'returning to home page if he tries to access another one order ' \
     'approval page' do
    first_buffet_owner = BuffetOwner.create! email: 'user@example.com', password: 'password'

    second_buffet_owner = BuffetOwner.create! email: 'another.user@example.com',
    ...
    expect(page).to have_content 'Você não pode aprovar pedidos de outros buffets'
  end
